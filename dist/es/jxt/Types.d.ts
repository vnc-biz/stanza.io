...
export declare const text: (defaultValue?: string) => FieldDefinition<string, string>;
...
export declare const childText: (namespace: string | null, element: string, defaultValue?: string, emitEmpty?: boolean) => FieldDefinition<string>;
...
export declare const childInteger: (namespace: string | null, element: string, defaultValue?: number) => FieldDefinition<number>;
export declare const childFloat: (namespace: string | null, element: string, defaultValue?: number) => FieldDefinition<number>;
