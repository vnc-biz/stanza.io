...
export function priorityQueue(worker, concurrency = 1) {
    ...
    const process = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            (_a = entry.callback) === null || _a === void 0 ? void 0 : _a.call(entry);
        }
        catch (err) {
            (_b = entry.callback) === null || _b === void 0 ? void 0 : _b.call(entry, err instanceof Error ? err : new Error(String(err)));
        }
        finally {
            running--;
            if (!killed) {
