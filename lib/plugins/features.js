...
module.exports = function (client) {
    ...
    client.on('streamFeatures', function (features) {
        ...
        // console.log("[stanza.io] on streamFeatures - features: ", features);
        if (client && client.config && client.config.transport && (client.config.transport === 'bosh')) {
          // console.log("[stanza.io] on streamFeatures - client is using BOSH - removing streamManagement ", client.config.transport);
          delete features.streamManagement;
        }
